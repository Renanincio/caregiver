      ...
      <section className="min-h-[100vh] bg-header flex flex-col justify-between">
        <div>
          <div className=" max-w-[1280px] m-auto p-8">
            <div className="flex text-center w-full justify-center mt-[200px] max-[450px]:flex-col max-[450px]:items-center">
              <p className="w-[300px]">
                Contato:
                <br />
                +55 21 97029-6191
              ...
              <h2 className="text-[48px] w-[300px] uppercase font-medium leading-10 italic max-[450px]:my-6">
                Insight
              </h2>
              <p className="w-[300px]">
        ...
        <footer className="bg-services min-h-[70px] ">
          <div className="max-w-[1280px] w-full h-[70px] mx-auto flex items-center justify-between max-[447px]:justify-center max-[447px]:text-center p-4">
